      ...
      <div className="md:max-w-frame mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2">
        <section className="max-w-frame px-4">
          <motion.h2
            ...
            className={cn([
              ...
              "text-4xl text-primary2 lg:text-[64px] lg:leading-[64px] mb-5 lg:mb-8",
            ])}
          >
            DISCOVER TOP QUALITY MEAT PRODUCTS
          </motion.h2>
          <motion.p
          ...
          >
            Homechoice Depot, a brand of Ed and Ann Distributors, provides top-quality meat
            products, including beef, chicken, lamb, goat, tilapia, Nile perch, sausages, and
            bacon. Established in 2020 during the COVID-19 pandemic, the company
            identified a strong demand for quality meat among hotels offering home delivery
          ...
          >
            <Link
              href="/shop"
              className="bg-primary2 w-full md:w-52 mb-5 md:mb-12 inline-block text-center bg-black hover:bg-black/80 transition-all text-white px-14 py-4 rounded-full hover:animate-pulse"
            >
              Shop Now
            </Link>
          </motion.div>
        ...
        >
          <Image
            ...
            width={150}
            alt="big star"
            className="absolute right-7 xl:right-0 top-12 max-w-[150px] max-h-[76px] lg:max-w-24 lg:max-h-max-w-24 xl:max-w-[150px] xl:max-h-[160px] animate-[spin_4s_infinite]"
          />
          <Image
            priority
